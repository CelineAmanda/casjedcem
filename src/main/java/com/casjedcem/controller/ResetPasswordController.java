...
import com.casjedcem.model.PasswordReset;
...
public class ResetPasswordController {
    ...
    @Autowired
    public ResetPasswordController(PasswordResetTokenService tokenService, MessageSource messageSource, UserServices userService) {
